...
//         formData.append("file", fs.createReadStream(imagePath)); // ✅ Send file as stream

//         // Send image to Streamlit API (correct API endpoint)
//         const response = await axios.post("http://127.0.0.1:5001/predict", formData, {
//           headers: { ...formData.getHeaders() },
//       });

//         // Delete temp image file after sending
//         fs.unlinkSync(imagePath);

//         res.json(response.data);
//     } catch (error) {
//         console.error("❌ Error sending image to Streamlit:", error.message);
//         res.status(500).json({ error: "Failed to get prediction" });
//     }
// });

// app.listen(5000, () => {
//     console.log("✅ Node.js server running at http://localhost:5000");
// });
...
//     const userData = new UserForm(req.body);
//     await userData.save();
